...
Typically, the way you make sure that you don't mutate existing state in a reducer is by creating clones of it using of [`Object.assign`](../object_assign) or the [object spread operator](../destructuring_rest_spread#objects).
